...
import { handlerGoBack, messageConfirm, alertConfirm, removeVietnameseTones } from "../../../../utils/helper";
...
const Adhoc_SurveyReportScreen = ({ navigation }) => {
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={styleDefault.contentMain}>
                ...
                {isQuestion == 1 ?
                    ...
                    />
                    :
                    <CapturePhotoList navigation={navigation}
                        data={dataPhoto} status={isUploaded} />
                }
            </View>
...
export default Adhoc_SurveyReportScreen;
