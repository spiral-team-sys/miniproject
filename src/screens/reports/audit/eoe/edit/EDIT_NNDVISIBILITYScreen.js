...
const EDIT_NNDVISIBILITYScreen = ({ itemMain, data, isUploaded = false, isRefreshData = false, callBackData }) => {
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            />
            <AuditProductsList
                key='nnd-visibility-screen'
                typeMain='NNDVISIBILITY'
...
export default EDIT_NNDVISIBILITYScreen;