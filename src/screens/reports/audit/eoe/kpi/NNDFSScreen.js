...
const NNDFSScreen = ({ itemMain, data, isUploaded = false, isRefreshData = false, callBackData }) => {
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            />
            <GroupData
                dataMain={dataGroup.sort((a, b) => a.BrandName.localeCompare(b.BrandName))}
                keyName='BrandName'
                keyValue='BrandId'
